...
class Youtube extends Component {
  ...
  componentDidMount() {
    fetch(
      "https://www.googleapis.com/youtube/v3/search?key=AIzaSyDVzivGCz0hhfwfWFSH14Yfl3wge33pLdY&channelId=UCE_M8A5yxnLfW0KghEeajjw&part=snippet,id&order=date&maxResults=6"
    )
        ...
        <div className="container">
          <div className="row h-100 align-items-center justify-content-center text-center">
            <div className="col-12">
              <div className="title-wraper bold2 video-title-wrapper">
                Latest Videos
              </div>
            </div>
